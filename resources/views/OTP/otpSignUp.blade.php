...
<body>
    <div class="container" id="container" style="display: flex">
        <div class="form-OTP-container" style="flex: 1">
            <form action="{{route('postCheckOTP')}}" method="POST">
                @csrf
                <h1 style="color: #27a776;">Nhập mã OTP</h1>
                <span>Mã xác nhập đã được gửi vào email đăng ký</span>
                <input type="text" placeholder="Nhập mã OTP" name="otp" required minlength="6" maxlength="6" />
